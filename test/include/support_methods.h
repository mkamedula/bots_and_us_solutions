...
struct PngData
{
    ...
    std::vector<std::vector<unsigned char>> pixels; //! Holds pixels
...
/**
 * Remove PNG images from a given directory. This method cleans the directory after the tests have been performed
 * to avoid any residual files on the next test runs.
 *
...
/**
 * Print a human-readable comparison of discrepancies found between the PNG files. Only first difference
